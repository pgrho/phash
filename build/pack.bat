"%~dp0nuget.exe" pack^
 ...
 "%~dp0nuget.exe" pack^
 "%~dp0..\src\Shipwreck.Phash.Bitmaps\Shipwreck.Phash.Bitmaps.csproj"^
 -OutputDirectory "%~dp0..\src\Shipwreck.Phash.Bitmaps\bin\Release" -IncludeReferencedProjects -Build -Properties Configuration=Release
